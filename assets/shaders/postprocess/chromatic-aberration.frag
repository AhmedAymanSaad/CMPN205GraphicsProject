...
void main(){
    ...
    frag_color.g = texture(tex, tex_coord);
    frag_color.r = texture(tex, vec2(tex_coord[0].x - STRENGTH, tex_coord[1].x - STRENGTH, tex_coord[2].x - STRENGTH))
    frag_color.b = texture(tex, vec2(tex_coord[0].x + STRENGTH, tex_coord[1].x + STRENGTH, tex_coord[2].x + STRENGTH))
